...
<div class="container">
    ...
    <form method="post" action="addxulitl.php">
        <label for="nganhhoc">Ngành học:</label>
        <select name="nganhhoc" id="nganhhoc" required>
            <option value="cntt">Công nghệ thông tin</option>
        </select>

        <label for="namhoc">Năm học (ví dụ: nam1):</label>
        <input type="text" name="namhoc" id="namhoc" required autocomplete="off">
        ...
        <input type="text" name="tenfile" id="tenfile" required autocomplete="off">

        <label for="duongdan">Đường dẫn (ví dụ: tailieuhocphan/chuong1-2.pdf):</label>
